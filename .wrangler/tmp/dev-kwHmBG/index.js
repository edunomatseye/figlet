...
var figlet_default = {
  async fetch(request, env2, ctx) {
    ...
    if (url.pathname === "/hello") {
      return new Response(`Hello from Cloudflare Worker! Env var: ${env2.MY_VARIABLE}`, { status: 200 });
    }
    if (url.pathname === "/ip") {
...
// .wrangler/tmp/bundle-DAzDaP/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = figlet_default;
...
// .wrangler/tmp/bundle-DAzDaP/middleware-loader.entry.ts
